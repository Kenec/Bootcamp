...
*/
'use strict'
var toTwenty = require('../labs2.js').toTwenty;
var toForty = require('../labs2.js').toForty;
var toOneThousand = require('../labs2.js').toOneThousand;
var search = require('../labs2.js').search;
